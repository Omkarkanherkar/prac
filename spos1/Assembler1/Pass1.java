...
class Pass1 {
    public static void main(String[] args) {
        ...
        int temp1 = 0;
        int f = 0;
        Obj[] literal_table = new Obj[100];
        Obj[] symbol_table = new Obj[100];
        Obj[] optab = new Obj[100];
        Pooltable[] pooltab = new Pooltable[5];
        String line;
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\harsh\\OneDrive\\Desktop\\MyCodes\\Web Tech\\CompleteProject\\youtube-next-pizza-ui\\public\\img\\MP1\\sample (1).txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\harsh\\OneDrive\\Desktop\\MyCodes\\Web Tech\\CompleteProject\\youtube-next-pizza-ui\\public\\img\\MP1\\output.txt"))) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\harsh\\OneDrive\\Desktop\\MyCodes\\Web Tech\\CompleteProject\\youtube-next-pizza-ui\\public\\img\\MP1\\output.txt"))) {
            System.out.println("\n******************************output1.txt********************\n");
